...
const FAQ_ITEMS = [
  ...
  { q: 'How does it work?', a: 'Choose your event, select the sections you\'re open to, and enter your maximum total price. Our system monitors live listings continuously. The moment a match appears at or below your price, we purchase automatically on your behalf.' },
  { q: 'Am I charged when I set a bid?', a: 'No. You\'re only charged if we successfully secure tickets. We may place a temporary hold to verify your payment method, but nothing is collected unless we deliver.' },
  ...
  { q: 'Will I always pay my maximum price?', a: 'No — that\'s your ceiling, not your price. If we find matching tickets for less, you pay a lower amount. Many times you might pay less than your ceiling.' },
